...
7. Generative-AI assistance in code drafting/debugging is permitted only with human review, execution-based verification, and explicit disclosure; “project-original” means not copied/vendored from third-party research source repositories, not “typed without AI assistance”.
